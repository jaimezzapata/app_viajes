...
export default function Guide() {
  ...
  return (
    <div className="bg-white text-zinc-600 font-sans antialiased selection:bg-zinc-200 selection:text-zinc-900 min-h-[100dvh]">
      ...
      <div className="md:hidden bg-white/80 backdrop-blur-md border-b border-zinc-100 p-4 sticky top-0 z-40 flex justify-between items-center">
        <a href="#top" className="font-medium text-zinc-900 flex items-center gap-2">
