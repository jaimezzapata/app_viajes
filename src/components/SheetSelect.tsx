    ...
    <>
      ...
      <AnimatePresence>
        {open ? (
          ...
          >
            <motion.div
              className="w-full max-w-lg rounded-t-3xl border border-zinc-900 bg-zinc-950 p-4 sm:rounded-3xl"
              initial={{ y: 24 }}
              animate={{ y: 0 }}
              exit={{ y: 24 }}
            ...
            >
              ...
              <div className="max-h-[60dvh] overflow-y-auto custom-scrollbar space-y-2">
                {options.map((o) => {
